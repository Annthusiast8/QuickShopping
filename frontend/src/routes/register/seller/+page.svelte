<script lang="ts">
  ...
  let userData: SellerData = {
    ...
    role: "seller", // Set the role explicitly
    shop_name: ""
  };
...
<div class="min-h-screen flex items-center justify-center p-4">
  <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 relative">
    ...
    <div class="text-center mb-8">
      ...
      <p class="text-gray-600 text-sm">Start selling with us today!</p>
    </div>
    ...
    <form on:submit|preventDefault={submitForm} class="space-y-4">
      ...
      <div class="relative my-6">
        ...
        <div class="relative flex justify-center text-sm">
          <span class="px-2 bg-white text-gray-500">Want to shop with us?</span>
        </div>
      </div>
