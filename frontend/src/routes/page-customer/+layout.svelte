<script lang="ts">
  ...
  // Navigation items
  const navItems = [
    { label: 'Dashboard', href: '/page-customer/dashboard', icon: 'chart-pie' },
    { label: 'Profile', href: '/page-customer/profile', icon: 'user' },
    { label: 'Orders', href: '/page-customer/orders', icon: 'shopping-bag' },
    { label: 'Favorites', href: '/page-customer/favorites', icon: 'heart' }
  ];
