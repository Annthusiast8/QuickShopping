...
<div class="container mx-auto px-4 py-8 max-w-6xl">
  ...
  {:else}
    ...
    {#each itemsBySeller as sellerGroup}
      <div class="bg-white rounded-lg shadow-md mb-4 overflow-hidden">
        ...
        {#each sellerGroup.items as item}
          <div class="p-4 grid grid-cols-12 gap-4 items-center border-b last:border-b-0 hover:bg-gray-50">
            <div class="col-span-1">
              <input 
                type="checkbox" 
            ...
            <div class="col-span-5 flex items-center">
              ...
              <div>
                ...
                <div class="text-sm text-gray-600">
                  Variations: {item.variation.color}
    ...
    <!-- Checkout section -->
    <div class="bg-white rounded-lg shadow-md bg-yellow-200 border-2 border-yellow-300 p-4 flex items-center justify-between sticky bottom-0 z-10">
      <div class="flex items-center">
        <input 
          type="checkbox" 
          checked={allItemsSelected}
        ...
        />
        <button 
          class="text-[#21463E] hover:underline mr-6"
      ...
      <div class="flex items-center">
        ...
        <button 
          class="px-6 py-2 bg-[#21463E] text-white rounded-md hover:bg-[#143129] disabled:opacity-50 disabled:cursor-not-allowed"
